...
import www.bejia.com.cn.demo.widget.datarow.EaseChatRow;
import www.bejia.com.cn.demo.widget.datarow.EaseChatRowText;
...
public class EaseMessageAdapter extends BaseAdapter {
    ...
    private ChatFragment.MessageListItemClickListener itemClickListener;
    ...
    Handler handler = new Handler() {
        private void refreshList() {
            ...
            LogUtil.i(TAG, messages.length + messages.toString());
    ...
    public void setItemClickListener(ChatFragment.MessageListItemClickListener listener) {
