...
import www.bejia.com.cn.demo.bean.EaseDefaultEmojiconDatas;
...
public class EaseSmileUtils {
    ...
    static {
        ...
        NimHelper.EaseEmojiconInfoProvider emojiconInfoProvider = NimHelper.getInstance().easeEmojiconInfoProvider;
